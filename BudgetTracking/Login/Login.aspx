<%@ Page Title="Accedi" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="BudgetTracking.Account.Login" Async="true" %>

<%@ Register Src="~/Login/Account/OpenAuthProviders.ascx" TagPrefix="uc" TagName="OpenAuthProviders" %>

<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="OrdersContentPlaceHolder">
    <%--<h2><%: Title %>.</h2>--%>
        <div class="row">
            <div class="col-md-6">

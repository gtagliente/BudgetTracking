...
namespace BudgetTracking.Account
{
    public partial class Manage : System.Web.UI.Page
    {
        ...
        protected void Page_Load()
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (message != null)
                {
                    ...
                    Form.Action = ResolveUrl("~/Login/Account/Manage");
        ...
        protected void RemovePhone_Click(object sender, EventArgs e)
        {
            ...
            if (user != null)
            {
                ...
                Response.Redirect("/Login/Account/Manage?m=RemovePhoneNumberSuccess");
            }
        }
        ...
        protected void TwoFactorDisable_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("/Login/Account/Manage");
        }
